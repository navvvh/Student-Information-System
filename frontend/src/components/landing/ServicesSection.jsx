...
const ServiceCard = ({ service }) => (
  ...
  >
    <div className="card-body p-0 flex flex-col items-center w-full">
      <h3 className="text-3xl font-bold font-alike text-white mb-6 leading-snug" style={{ minHeight: "5rem" }}>
        {service.title}
      </h3>
  ...
  return (
    <section className="w-full py-16 md:py-24 bg-white px-4 shadow-inner shadow-gray-400">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold font-alike text-gray-900 mb-12 text-center">Our Services</h2>
        ...
        <div className="flex flex-col items-center justify-center text-center px-4">
          ...
          <button
            ...
            className="btn font-alike bg-[#620C12] text-white hover:bg-[#4f090f] px-10 py-3 border-none rounded-lg shadow-lg"
          >
            Get Started
          </button>
        </div>
